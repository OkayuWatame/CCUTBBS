<%-- 
    Document   : studentwrite
    Created on : 2020-6-21, 13:08:38
    Author     : 22603
--%>
			...
			<div >
				<div style="margin-left: 50px;">
					<div style="margin-left: 50px;"><br>
                                    <form action="postwrite.action" method="post">                    
					文章名：
					...
					发布板块:(1.注水区 2.学习交流区)
                                        <select name="bid">
                                            <option value="1">注水区</option>
                                            <option value="2">学习交流区</option>
                                        </select><br>
                                        发布时间：					
